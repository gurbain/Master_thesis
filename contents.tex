...
\newglossaryentry{ISAE}{name=ISAE, description={Institut Sup\'{e}rieur de l'A\'{e}ronautique et de l'Espace}}
...
\newglossaryentry{PCL}{name=PCL, description={Point Cloud Library}}
\newglossaryentry{SLAM}{name=SLAM, description={Simultaneous Localization and Mapping}}
\newglossaryentry{TRL}{name=TRL, description={Technology Readiness Level}}
\printglossaries
